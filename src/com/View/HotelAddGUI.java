...
public class HotelAddGUI extends JFrame {
    ...
    private JTextArea txt_features;
    ...
    public HotelAddGUI(Employee employee) {
        ...
        btn_hotel_add.addActionListener(e -> {
            if (Helper.isFieldEmpty(fld_hotel_name) || Helper.isAreaEmpty(txt_features) || Helper.isAreaEmpty(txt_hotel_address) ||
                    Helper.isFieldEmpty(fld_hotel_phone) || Helper.isFieldEmpty(fld_hotel_email) ||
                    (!radioButton1.isSelected() && !radioButton2.isSelected() && !radioButton3.isSelected() &&
                            !radioButton4.isSelected() && !radioButton5.isSelected() && !radioButton6.isSelected() && !radioButton7.isSelected()
                ...
                String property = txt_features.getText();
                String adress = txt_hotel_address.getText();
                ...
                if (Hotel.add(name, star, property, adress, phone, email)) {
                    ...
                    txt_features.setText(null);
                    txt_hotel_address.setText(null);
